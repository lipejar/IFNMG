...
public class Principal {
    public static void main(String[] args) {
        ...
        while (sair != 0){
            ...
            switch (opc){
                case 1:
                    System.out.println(teste.consultarSaldo());
                    break;
                ...
                case 4:
                    ...
                    trouxa.nome = input.nextLine();

                    System.out.println("Digite o sobrenome do Cliente: ");
                    trouxa.sobrenome = input.nextLine();

                    System.out.println("Digite o CPF do Cliente usando apenas números: ");
                    trouxa.cpf = input.nextLine();

                    teste.titular = trouxa;

                    System.out.println("======= Informações feitas com sucesso! =======");
                    break;

                case 5:
                    if (teste.titular == null){
                        System.out.println("Informações não inseridas anteriormente.");
                        break;
                    }

                    System.out.println("Nome: "+ teste.titular.nome +
                            "\nSobrenome: " + teste.titular.sobrenome +
                            "\nCPF: " + teste.titular.cpf);
                    break;
